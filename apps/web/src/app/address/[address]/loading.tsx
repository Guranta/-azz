  ...
  return (
    <main className="relative mx-auto flex w-full max-w-6xl flex-1 items-center px-6 py-12 md:px-10">
      <section className="loading-surface relative w-full overflow-hidden rounded-[36px] border border-white/12 bg-[linear-gradient(135deg,rgba(14,27,47,0.96)_0%,rgba(7,13,24,0.92)_52%,rgba(10,23,40,0.88)_100%)] px-6 py-16 shadow-[0_42px_140px_rgba(1,5,16,0.56)] backdrop-blur-[18px] md:px-10 md:py-20">
        {/* Ambient glow */}
        <div className="pointer-events-none absolute right-[22%] top-[-12%] h-36 w-36 animate-[driftGlow_7s_ease-in-out_infinite_alternate] rounded-full bg-[radial-gradient(circle,rgba(103,232,249,0.16)_0%,transparent_70%)] blur-3xl" />
        <div className="pointer-events-none absolute bottom-[-6%] left-[20%] h-32 w-32 animate-[driftGlow_9s_ease-in-out_infinite_alternate-reverse] rounded-full bg-[radial-gradient(circle,rgba(244,199,106,0.14)_0%,transparent_70%)] blur-3xl" />
